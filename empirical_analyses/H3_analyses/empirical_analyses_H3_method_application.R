...
load('evenly_sampled_(no_passage_filter)/H3_even_trees.RData')

t_bh <- H3_tree_even_dated$intree # H3_tree_uneven
v_est <- H3_tree_even_dated # H3_tree_uneven_dated
...
cat("\nDetection of structured rate variation between",deme1, "and",deme2,"in evenly-sampled H3 phylogeny\n") 
...
load('unevenly_sampled/H3_uneven_trees.RData')

t_bh <- H3_tree_uneven_dated$intree # H3_tree_uneven
v_est <- H3_tree_uneven_dated # H3_tree_uneven_dated
...
cat("\nDetection of structured rate variation between",deme1, "and",deme2,"in unevenly-sampled H3 phylogeny\n") 
cat("Test statistic p-values are listed, with significance at 0.05 marked\n")
cat("\nMean-difference test statistic\n",sig(p_mean), "\n\n",sep="")
cat("Mean-ratio test statistic\n",sig(p_ratio), "\n\n",sep="")
cat("Welch\'s t-test statistic\n",sig(p_tstat), "\n\n",sep="")
