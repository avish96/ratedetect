...
scenario <- 'kscale_highshape_sampled_third'
...
y <- foreach (
  ...
  # Sampling
  dropped <- sample(v_p1$tip.label,length(v_p1$tip.label)/3,prob=rev(sort(rep(normalized_weights, length.out = length(v_p1$tip.label)))))
